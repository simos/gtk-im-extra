...
static void ti_er_class_init (GtkIMContextEthiopicClass *class);
static void ti_er_init (GtkIMContextEthiopic *im_context);
...
static void
ti_er_class_init (GtkIMContextEthiopicClass *class)
{
}

static void
ti_er_init (GtkIMContextEthiopic *im_context)
{
