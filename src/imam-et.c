...
static void am_et_class_init (GtkIMContextEthiopicClass *class);
static void am_et_init (GtkIMContextEthiopic *im_context);
...
/*
 * We don't need this as it turns out the circle sequences
 * are the same for am, ti_et, ti_er, this may not always
 * be the case.
 *
static const char *gtk_im_am_ethiopic_circles[] = {
	"aaaaa",
	"eeeeee",
	"AAA",
	"::::",
...
static void
am_et_class_init (GtkIMContextEthiopicClass *class)
{
}

static void
am_et_init (GtkIMContextEthiopic *im_context)
{
  ...
  /* im_context->circles = gtk_im_am_ethiopic_circles; */
}
